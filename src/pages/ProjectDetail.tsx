...
import { GET_TASKS_BY_PROJECT, CREATE_TASK, UPDATE_TASK, DELETE_TASK } from '@/graphql/mutations/projects';
...
const ProjectDetail = () => {
  ...
  const { data, loading, refetch } = useQuery(GET_TASKS_BY_PROJECT, {
    variables: { projectId },
    skip: !projectId,
  });
  ...
  const handleCreateTask = async (e: React.FormEvent) => {
    ...
    try {
      await createTask({ variables: { input: { title, description, projectId, status: 'TODO' } } });
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Kanban view of your project tasks</p>
          </div>
        ...
        {!loading && tasks.length === 0 && (
          <Card className="border-border">
            <CardContent className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-muted-foreground">Create your first task to start tracking work</p>
            </CardContent>
          </Card>
        )}
      </div>
